        ...
        <div class="row">
            <div class="pagamento">
                <div class="pagamento__form">
                    <h2 class="heading-2 pagamento__form-heading">Alterar cartão</h2>
                    

                    <div class="alterar-cartao__formas mg-bottom-4">
                        <div class="alterar-cartao__forma--cartao" id="alterar-cartao__forma">
                            Cartão de crédito
                        </div>
                    </div>
